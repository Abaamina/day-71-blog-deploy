...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://posts_9oop_user:4hDC4OyqlHcjGvug5LmDGYKkCvlcniDM@dpg-ck4kod42kpls73ek9fb0-a/posts_9oop"
db = SQLAlchemy()
db.init_app(app)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = User(email=form.email.data, password=hashed_pwd, name=form.name.data)
        db.session.add(user)
        db.session.commit()
        login_user(user)
